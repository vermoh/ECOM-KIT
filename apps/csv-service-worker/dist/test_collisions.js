...
const ai = __importStar(require("./lib/ai"));
// Mock dependencies
jest.mock('./lib/ai');
jest.mock('./lib/s3', () => ({
...
describe('Collision Detection Logic', () => {
    ...
    it('should detect low confidence and missing required fields', async () => {
        ...
        shared_db_1.db.query.enrichmentRuns.findFirst.mockResolvedValue({
            id: runId,
            orgId,
            template: { fields: mockFields }
        });
        // 2. Mock AI response to trigger collisions
        ai.enrichItem.mockResolvedValueOnce({
...
//# sourceMappingURL=test_collisions.js.map